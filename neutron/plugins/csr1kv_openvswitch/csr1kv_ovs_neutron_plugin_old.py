...
class CSR1kv_OVSNeutronPluginV2(db_base_plugin_v2.NeutronDbPluginV2,
    ...
    _supported_extension_aliases = ["provider", "external-net", "router", "trunkport",
                                    "binding", "quotas", "security-group",
                                    "agent", "extraroute", "l3_agent_scheduler",
    ...
    def _update_trunk_mappings(self, context, network_id, trunk_mappings):
        ...
        with context.session.begin(subtransactions=True):
            ...
            for net_id in trunks_to_add | trunks_to_modify:
                ...
                net = super(CSR1kv_OVSNeutronPluginV2, self).get_network(
                    context, net_id)
    ...
    def create_network(self, context, network):
        ...
        with session.begin(subtransactions=True):
            if not network_type:
                ...
                # no reservation needed for TYPE_LOCAL
            net = super(CSR1kv_OVSNeutronPluginV2, self).create_network(
                            context, network)
    ...
    def create_port(self, context, port):
        ...
        with session.begin(subtransactions=True):
            ...
            port = super(CSR1kv_OVSNeutronPluginV2, self).create_port(context,
                                                                      port)
